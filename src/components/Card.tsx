                ...
                <div className="md:grid md:grid-cols-[120px_minmax(900px,_1fr)_100px]">
                    ...
                    <div className="md:w-[630px] ">
                        <div className="md:grid md:grid-cols-2 md:justify-between md:items-center ">
                            <h2 className="text-black font-bold dark:text-white">{props.userData.name}</h2>
                            <p>Joined {day} {month} {year}</p>
                            <p className="text-Primary font-normal dark:font-bold">@{props.userData.login}</p>
                        </div>
                        <div className="">
                        ...
                        <div className="bg-Light dark:bg-bgThird flex justify-between px-8 py-4 mb-8 rounded-xl">
                            <h4 className="flex flex-col">repos <p className="text-black font-bold text-2xl dark:text-white">{props.userData.public_repos}</p></h4>
                            <h4 className="flex flex-col">Followers <p className="text-black font-bold text-2xl dark:text-white">{props.userData.followers}</p> </h4>
                            <h4 className="flex flex-col">Following <p className="text-black font-bold text-2xl dark:text-white">{props.userData.following}</p></h4>
                        </div>
